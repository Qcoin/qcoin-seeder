...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Qcoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.qcoin.co", ""};
static const string testnet_seeds[] = {"testnet-seed.qcointools.com", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9785), true);
  }
  do {
